...
Preprocessors          :=$(PreprocessorSwitch)NDEBUG $(PreprocessorSwitch)_LINUX $(PreprocessorSwitch)__WXGTK__ 
ObjectSwitch           :=-o 
ArchiveOutputSwitch    := 
...
$(OutputFile): $(Objects)
	...
	@echo rebuilt > "/home/figuinha/dev/Regards/.build-release/libExif"

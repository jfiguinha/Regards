========================================================================
    BIBLIOTHÈQUE STATIQUE : Vue d'ensemble du projet libFiltreInterface
========================================================================

AppWizard a créé ce projet de bibliothèque libFiltreInterface à votre intention.

Aucun fichier source n'a été créé dans le cadre de votre projet.


libFiltreInterface.vcxproj
...
libFiltreInterface.vcxproj.filters

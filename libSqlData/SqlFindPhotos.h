...
namespace Regards
{
	namespace Sqlite
	{
		...
		public:
            ...
            wxString GenerateSqlRequest(const int &numCatalog, vector<int> & listFolder, vector<int> & listCriteriaNotIn, vector<int> & listFaceNotIn, vector<int> & listFaceSelected, vector<int> & listStarSelected, vector<int> & listStarNotSelected, const double & pertinence = 0.0);

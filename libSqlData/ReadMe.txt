========================================================================
    BIBLIOTHÈQUE STATIQUE : Vue d'ensemble du projet libSqlDataPicture
========================================================================

AppWizard a créé ce projet de bibliothèque libSqlDataPicture à votre intention.

Aucun fichier source n'a été créé dans le cadre de votre projet.


libSqlDataPicture.vcxproj
...
libSqlDataPicture.vcxproj.filters

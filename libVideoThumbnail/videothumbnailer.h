...
public:
	...
	cv::Mat GetThumbnail(const std::string& videoFile, MovieDecoder * movieDecoder, const int &percent, const int & thumbnailWidth, const int & thumbnailHeight, const int & rotation);
    ...
    cv::Mat generateThumbnail(const std::string& videoFile, const int & thumbnailWidth, const int & thumbnailHeight, int & rotation, AVFormatContext* pAvContext = NULL);

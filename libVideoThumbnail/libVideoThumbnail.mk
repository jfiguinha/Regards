...
Preprocessors          :=$(PreprocessorSwitch)NDEBUG $(PreprocessorSwitch)LATEST_GREATEST_FFMPEG $(PreprocessorSwitch)__WXGTK__ 
ObjectSwitch           :=-o 
ArchiveOutputSwitch    := 
...
$(OutputFile): $(Objects)
	...
	@echo rebuilt > "/home/figuinha/dev/Regards/.build-release/libVideoThumbnail"

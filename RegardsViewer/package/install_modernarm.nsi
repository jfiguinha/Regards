...
Section "RegardsViewer" SecRegardsViewer
  ...
  DetailPrint "*** Installing Regards Viewer 2.84.8..."
...
;Descriptions
  ...
  ;Language strings
  LangString DESC_SecRegardsViewer ${LANG_ENGLISH} "Regards Viewer 2.84.8"

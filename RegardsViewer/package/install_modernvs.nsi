...
;--------------------------------
;Installer Sections
Section "Regards Viewer 2.67.9" SecRegardsViewer

  SetOutPath "$INSTDIR"


  ;ADD YOUR OWN FILES HERE...
  DetailPrint "*** Installing Regards Viewer 2.67.9..."
...
;Descriptions
  ...
  ;Language strings
  LangString DESC_SecRegardsViewer ${LANG_ENGLISH} "Regards Viewer 2.67.9"

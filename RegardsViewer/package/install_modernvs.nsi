...
Section "RegardsViewer" SecRegardsViewer
  ...
  DetailPrint "*** Installing Regards Viewer 2.85.2..."
...
;Descriptions
  ...
  ;Language strings
  LangString DESC_SecRegardsViewer ${LANG_ENGLISH} "Regards Viewer 2.85.2"

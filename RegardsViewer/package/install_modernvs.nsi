...
Section "RegardsViewer" SecRegardsViewer
  ...
  DetailPrint "*** Installing Regards Viewer 2.83.9..."
...
;Descriptions
  ...
  ;Language strings
  LangString DESC_SecRegardsViewer ${LANG_ENGLISH} "Regards Viewer 2.83.9"

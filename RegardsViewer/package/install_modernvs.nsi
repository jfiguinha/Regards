...
Section "RegardsViewer" SecRegardsViewer
  ...
  DetailPrint "*** Installing Regards Viewer 3.04.0..."
...
;Descriptions
  ...
  ;Language strings
  LangString DESC_SecRegardsViewer ${LANG_ENGLISH} "Regards Viewer 3.04.0"

...
uint CalculInterpolation(const __global uint *input, int widthIn, int heightIn, int widthOut, int heightOut, int type, float ratioX, float ratioY, int x, int y, float left, float top)
{
...
//Interpolation
//----------------------------------------------------------------------------
__kernel void Interpolation(__global uint *output, const __global uint *input, int widthIn, int heightIn, int widthOut, int heightOut, int type)
{
	int width = widthOut;
	...
	output[position] = CalculInterpolation(input, widthIn, heightIn, widthOut, heightOut, type, ratioX, ratioY, x, y, 0, 0);
}

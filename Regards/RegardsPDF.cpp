...
void RegardsPDFApp::OnInitCmdLine(wxCmdLineParser& parser)
{
...
bool RegardsPDFApp::OnCmdLineParsed(wxCmdLineParser& parser)
{
    /*
...
// ----------------------------------------------------------------------------
#ifdef __APPLE__
void RegardsPDFApp::MacOpenFile(const wxString &fileName)
{
...
//
wxString RegardsPDFApp::GetImageFilter()
{
...
//
void RegardsPDFApp::AddImageHandler( wxImageHandler* poHandler )
{
    if( poHandler )
    {

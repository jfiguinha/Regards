...
LinkOptions            :=  
IncludePath            := $(IncludeSwitch)/opt/AMDAPPSDK-3.0/include $(IncludeSwitch)/usr/include/OpenEXR $(IncludeSwitch)/usr/include/pango-1.0 $(IncludeSwitch)/usr/include/glib-2.0 $(IncludeSwitch)/usr/lib/x86_64-linux-gnu/glib-2.0/include $(IncludeSwitch)/usr/include/cairo $(IncludeSwitch)/usr/include/SDL2 $(IncludeSwitch)/usr/include/libxml2 $(IncludeSwitch)/usr/include/libexif  $(IncludeSwitch)../../libextern/ffmpeg-4.1 $(IncludeSwitch)../../libextern/libexif-master $(IncludeSwitch)../wxSVG/include $(IncludeSwitch)../wxSVG/include/wxSVG $(IncludeSwitch)../wxSVG/include/wxSVGXML 

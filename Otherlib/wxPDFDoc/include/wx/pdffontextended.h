...
public:
	...
	*/
	wxString ConvertCID2GID(const wxString& s, wxPdfSortedArrayInt* usedGlyphs = nullptr,
	...
	* \return the converted string
	*/
	wxString ConvertGlyph(wxUint32 glyph, wxPdfSortedArrayInt* usedGlyphs = nullptr,
	                      wxPdfChar2GlyphMap* subsetGlyphs = nullptr);

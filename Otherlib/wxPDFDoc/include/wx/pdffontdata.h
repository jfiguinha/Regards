...
public:
	...
	*/
	virtual double GetStringWidth(const wxString& s, const wxPdfEncoding* encoding = nullptr,
	                              bool withKerning = false) const;
	...
	*/
	virtual bool CanShow(const wxString& s, const wxPdfEncoding* encoding = nullptr) const;
	...
	*/
	virtual wxString ConvertCID2GID(const wxString& s, const wxPdfEncoding* encoding = nullptr,
	...
	* \return the converted string
	*/
	virtual wxString ConvertGlyph(wxUint32 glyph, const wxPdfEncoding* encoding = nullptr,
	                              wxPdfSortedArrayInt* usedGlyphs = nullptr,
	                              wxPdfChar2GlyphMap* subsetGlyphs = nullptr) const;
	...
	*/
	virtual size_t WriteFontData(wxOutputStream* fontData,
	                             wxPdfSortedArrayInt* usedGlyphs = nullptr,
	                             wxPdfChar2GlyphMap* subsetGlyphs = nullptr);

...
public:
	...
	~wxPdfPrintPreviewImpl() override;
...
public:
	...
	~wxPdfPageSetupDialogCanvas() override;
...
public:
	...
	int GetResolution() const override { return m_pdfdc->GetResolution(); }

	bool CanGetTextExtent() const override { return m_pdfdc->CanGetTextExtent(); }

	wxCoord GetCharHeight() const override { return m_pdfdc->GetCharHeight(); }
	wxCoord GetCharWidth() const override { return m_pdfdc->GetCharWidth(); }
	...
	wxSize GetPPI() const override { return m_pdfdc->GetPPI(); }
...
public:
	...
	void CalcBoundingBox(wxCoord x, wxCoord y) override
	{
	...
	const wxFont& GetFont() const override { return m_dc.GetFont(); }

	void SetPen(const wxPen& pen) override { m_dc.SetPen(pen); }
	const wxPen& GetPen() const override { return m_dc.GetPen(); }
	void SetBrush(const wxBrush& brush) override { m_dc.SetBrush(brush); }
	const wxBrush& GetBrush() const override { return m_dc.GetBrush(); }
	void SetBackground(const wxBrush& brush) override { m_dc.SetBackground(brush); }
	const wxBrush& GetBackground() const override { return m_dc.GetBackground(); }
	void SetBackgroundMode(int mode) override { m_dc.SetBackgroundMode(mode); }
	int GetBackgroundMode() const override { return m_dc.GetBackgroundMode(); }

	void SetTextForeground(const wxColour& colour) override { m_dc.SetTextForeground(colour); }
	const wxColour& GetTextForeground() const override { return m_dc.GetTextForeground(); }

	void SetTextBackground(const wxColour& colour) override { m_dc.SetTextBackground(colour); }
	const wxColour& GetTextBackground() const override { return m_dc.GetTextBackground(); }

#if wxUSE_PALETTE
	void SetPalette(const wxPalette& palette) override { m_dc.SetPalette(palette); }
#endif // wxUSE_PALETTE

	void InheritAttributes(wxWindow* win) override { m_dc.InheritAttributes(win); }

	void SetLogicalFunction(wxRasterOperationMode function) override { m_dc.SetLogicalFunction(function); }
	wxRasterOperationMode GetLogicalFunction() const override { return m_dc.GetLogicalFunction(); }
  ...
  virtual void DoGetClippingBox(wxCoord* x, wxCoord* y, wxCoord* w, wxCoord* h) const
  {
	...
	wxCoord DeviceToLogicalX(wxCoord x) const override { return m_dc.DeviceToLogicalX(x); }
	wxCoord DeviceToLogicalY(wxCoord y) const override { return m_dc.DeviceToLogicalY(y); }
	wxCoord DeviceToLogicalXRel(wxCoord x) const override { return m_dc.DeviceToLogicalXRel(x); }
	wxCoord DeviceToLogicalYRel(wxCoord y) const override { return m_dc.DeviceToLogicalYRel(y); }
	wxCoord LogicalToDeviceX(wxCoord x) const override { return m_dc.LogicalToDeviceX(x); }
	wxCoord LogicalToDeviceY(wxCoord y) const override { return m_dc.LogicalToDeviceY(y); }
	wxCoord LogicalToDeviceXRel(wxCoord x) const override { return m_dc.LogicalToDeviceXRel(x); }
	wxCoord LogicalToDeviceYRel(wxCoord y) const override { return m_dc.LogicalToDeviceYRel(y); }

	void SetMapMode(wxMappingMode mode) override { m_dc.SetMapMode(mode); }
	wxMappingMode GetMapMode() const override { return m_dc.GetMapMode(); }

	void SetUserScale(double x, double y) override { m_dc.SetUserScale(x, y); }
	void GetUserScale(double* x, double* y) const override { m_dc.GetUserScale(x, y); }

	void SetLogicalScale(double x, double y) override { m_dc.SetLogicalScale(x, y); }
	void GetLogicalScale(double* x, double* y) const override { m_dc.GetLogicalScale(x, y); }

	void SetLogicalOrigin(wxCoord x, wxCoord y) override { m_dc.SetLogicalOrigin(x, y); }
	void DoGetLogicalOrigin(wxCoord* x, wxCoord* y) const override { m_dc.DoGetLogicalOrigin(x, y); }

	void SetDeviceOrigin(wxCoord x, wxCoord y) override { m_dc.SetDeviceOrigin(x, y); }
	void DoGetDeviceOrigin(wxCoord* x, wxCoord* y) const override { m_dc.DoGetDeviceOrigin(x, y); }

	void SetDeviceLocalOrigin(wxCoord x, wxCoord y) override { m_dc.SetDeviceLocalOrigin(x, y); }
	void ComputeScaleAndOrigin() override { m_dc.ComputeScaleAndOrigin(); }
	void SetAxisOrientation(bool x, bool y) override { m_dc.SetAxisOrientation(x, y); }

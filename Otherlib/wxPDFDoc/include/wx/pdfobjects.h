...
public:
	...
	/// Destructor
	~wxPdfIndirectReference() override;
};
...
public:
	...
	/// Destructor
	~wxPdfNumber() override;

	/// Get value as floating point
	double GetValue() { return m_value; }

	/// Get value as integer
	int GetInt() { return static_cast<int>(m_value); }
...
public:
	/// Constructor
	wxPdfObjectQueue(int originalId = 0, int actualObjectId = 0, wxPdfObject* object = nullptr);

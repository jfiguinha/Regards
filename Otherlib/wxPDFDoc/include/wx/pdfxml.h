...
public:
	...
	unsigned int GetLineCount() { return static_cast<unsigned int>(m_linewidth.GetCount()); }
	...
	unsigned int GetContextCount() { return static_cast<unsigned int>(m_contexts.GetCount()); }

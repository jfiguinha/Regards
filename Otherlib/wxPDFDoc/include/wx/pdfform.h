...
public:
	...
	*/
	...
	/// Destructor
	~wxPdfAnnotationObject() override;
...
public:
	...
	*/
	...
	/// Destructor
	~wxPdfAnnotationWidget() override;
...
public:
	...
	unsigned int GetCount() { return static_cast<unsigned int>(m_radios.GetCount()); }

...
public:
	...
	*/
	virtual void SetDrawColour(unsigned char grayscale);
	...
	* \see SetFillColour(), SetTextColour(), Line(), Rect(), Cell(), MultiCell()
	*/
	virtual void SetDrawColour(unsigned char red, unsigned char green, unsigned char blue);
	...
	*/
	virtual void SetFillColour(unsigned char grayscale);
	...
	* \see SetDrawColour(), SetTextColour(), Rect(), Cell(), MultiCell()
	*/
	virtual void SetFillColour(unsigned char red, unsigned char green, unsigned char blue);
	...
	*/
	virtual void SetTextColour(unsigned char grayscale);
	...
	* \see SetDrawColour(), SetFillColour(), Text(), Cell(), MultiCell()
	*/
	virtual void SetTextColour(unsigned char red, unsigned char green, unsigned char blue);
  ...
  virtual bool AddFontCJK(const wxString& family)
  {
	...
	* \param angle: angle in degrees.
	*/
	virtual void RotatedText(double textX, double textY, double rotationX, double rotationY, const wxString& txt,
	                         double angle);

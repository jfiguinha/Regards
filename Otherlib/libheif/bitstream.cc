...
bool StreamReader_istream::read(void* data, size_t size)
{
	...
	m_istr->read(static_cast<char*>(data), size);
	return true;
}
...
void StreamWriter::write16(uint16_t v)
{
	...
	m_data[m_position++] = static_cast<uint8_t>((v >> 8) & 0xFF);
	m_data[m_position++] = static_cast<uint8_t>(v & 0xFF);
}
...
void StreamWriter::write32(uint32_t v)
{
	...
	m_data[m_position++] = static_cast<uint8_t>((v >> 24) & 0xFF);
	m_data[m_position++] = static_cast<uint8_t>((v >> 16) & 0xFF);
	m_data[m_position++] = static_cast<uint8_t>((v >> 8) & 0xFF);
	m_data[m_position++] = static_cast<uint8_t>(v & 0xFF);
}
...
void StreamWriter::write64(uint64_t v)
{
	...
	m_data[m_position++] = static_cast<uint8_t>((v >> 56) & 0xFF);
	m_data[m_position++] = static_cast<uint8_t>((v >> 48) & 0xFF);
	m_data[m_position++] = static_cast<uint8_t>((v >> 40) & 0xFF);
	m_data[m_position++] = static_cast<uint8_t>((v >> 32) & 0xFF);
	m_data[m_position++] = static_cast<uint8_t>((v >> 24) & 0xFF);
	m_data[m_position++] = static_cast<uint8_t>((v >> 16) & 0xFF);
	m_data[m_position++] = static_cast<uint8_t>((v >> 8) & 0xFF);
	m_data[m_position++] = static_cast<uint8_t>(v & 0xFF);

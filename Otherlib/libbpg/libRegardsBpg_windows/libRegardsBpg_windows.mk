...
ProjectPath            :=C:/developpement/git/Regards/Otherlib/libbpg/libRegardsBpg_windows
...
LibPath                :=$(LibraryPathSwitch)"C:\Program Files (x86)\AMD APP SDK\3.0_mingw\lib\x86_64"  $(LibraryPathSwitch). $(LibraryPathSwitch)../../../libextern/x265_2.5/build/msys/8bit $(LibraryPathSwitch)../libbpg/Debug $(LibraryPathSwitch)../libavutil/Debug $(LibraryPathSwitch)../libavcodec/Debug 
...
$(IntermediateDirectory)/up_libRegardsBpg_bpgenc.c$(ObjectSuffix): ../libRegardsBpg/bpgenc.c $(IntermediateDirectory)/up_libRegardsBpg_bpgenc.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/developpement/git/Regards/Otherlib/libbpg/libRegardsBpg/bpgenc.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_libRegardsBpg_bpgenc.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/up_libRegardsBpg_bpgdec.c$(ObjectSuffix): ../libRegardsBpg/bpgdec.c $(IntermediateDirectory)/up_libRegardsBpg_bpgdec.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/developpement/git/Regards/Otherlib/libbpg/libRegardsBpg/bpgdec.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_libRegardsBpg_bpgdec.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/up_libRegardsBpg_x265_glue.c$(ObjectSuffix): ../libRegardsBpg/x265_glue.c $(IntermediateDirectory)/up_libRegardsBpg_x265_glue.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/developpement/git/Regards/Otherlib/libbpg/libRegardsBpg/x265_glue.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_libRegardsBpg_x265_glue.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/up_libRegardsBpg_DllBpg.cpp$(ObjectSuffix): ../libRegardsBpg/DllBpg.cpp $(IntermediateDirectory)/up_libRegardsBpg_DllBpg.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/developpement/git/Regards/Otherlib/libbpg/libRegardsBpg/DllBpg.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_libRegardsBpg_DllBpg.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/up_libRegardsBpg_dllmain.cpp$(ObjectSuffix): ../libRegardsBpg/dllmain.cpp $(IntermediateDirectory)/up_libRegardsBpg_dllmain.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/developpement/git/Regards/Otherlib/libbpg/libRegardsBpg/dllmain.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_libRegardsBpg_dllmain.cpp$(ObjectSuffix) $(IncludePath)

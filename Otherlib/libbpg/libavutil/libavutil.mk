...
ProjectPath            :=C:/developpement/git/Regards/Otherlib/libbpg/libavutil
...
WXCFG:=lib/mswud
Objects0=$(IntermediateDirectory)/pixdesc.c$(ObjectSuffix) $(IntermediateDirectory)/mem.c$(ObjectSuffix) $(IntermediateDirectory)/md5.c$(ObjectSuffix) $(IntermediateDirectory)/log2_tab.c$(ObjectSuffix) $(IntermediateDirectory)/buffer.c$(ObjectSuffix) $(IntermediateDirectory)/frame.c$(ObjectSuffix) 
...
$(OutputFile): $(Objects)
	...
	@echo rebuilt > "C:\developpement\git\Regards/.build-debug/libavutil"
...
$(IntermediateDirectory)/pixdesc.c$(ObjectSuffix): pixdesc.c $(IntermediateDirectory)/pixdesc.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/developpement/git/Regards/Otherlib/libbpg/libavutil/pixdesc.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/pixdesc.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/mem.c$(ObjectSuffix): mem.c $(IntermediateDirectory)/mem.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/developpement/git/Regards/Otherlib/libbpg/libavutil/mem.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/mem.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/md5.c$(ObjectSuffix): md5.c $(IntermediateDirectory)/md5.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/developpement/git/Regards/Otherlib/libbpg/libavutil/md5.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/md5.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/log2_tab.c$(ObjectSuffix): log2_tab.c $(IntermediateDirectory)/log2_tab.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/developpement/git/Regards/Otherlib/libbpg/libavutil/log2_tab.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/log2_tab.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/buffer.c$(ObjectSuffix): buffer.c $(IntermediateDirectory)/buffer.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/developpement/git/Regards/Otherlib/libbpg/libavutil/buffer.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/buffer.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/frame.c$(ObjectSuffix): frame.c $(IntermediateDirectory)/frame.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/developpement/git/Regards/Otherlib/libbpg/libavutil/frame.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/frame.c$(ObjectSuffix) $(IncludePath)

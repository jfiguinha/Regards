...
public :
	...
	FREE_IMAGE_FORMAT AddNode(FI_InitProc proc, int numFormat, void *instance = NULL, const char *format = 0, const char *description = 0, const char *extension = 0, const char *regexpr = 0);

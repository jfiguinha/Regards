========================================================================
    BIBLIOTHÈQUE STATIQUE : Vue d'ensemble du projet libRegardsRaw
========================================================================

AppWizard a créé ce projet de bibliothèque libRegardsRaw à votre intention.

Aucun fichier source n'a été créé dans le cadre de votre projet.


libRegardsRaw.vcxproj

...
public:
	...
	int ExecuteFFmpegExtractVideo(const wxString& inputVideoFile, const wxString& outputFile);
	int ExecuteFFmpegExtractAudio(const wxString& inputVideoFile, const wxString& outputFile);

...
namespace Regards
{
	...
	namespace Viewer
	{
		...
		private:
			...
			std::unique_ptr<CThumbnailFaceToolBar> thumbFaceToolbar;
			std::unique_ptr<CThumbnailFacePertinenceToolBar> thumbFacePertinenceToolbar;
			std::unique_ptr<CThumbnailFace> thumbnailFace;

...
CVideoFilter::CVideoFilter()
{
	...
	enableColorEffect = "Effect.ColorBoost.Enable";//CLibResource::LoadStringFromResource(L"LBLenableColorEffect",1);//L"Color Boost.Enable";
	enableBandCEffect = "Effect.BrightnessContrast.Enable";//CLibResource::LoadStringFromResource(L"LBLenableBandCEffect",1);//L"Tone.Enable";    
	toneConstrastLevel = "Effect.BrightnessContrast.Contrast";//CLibResource::LoadStringFromResource(L"LBLtoneConstrastLevel",1);//L"Tone.Constrast.Level";
	toneBrightnessLevel = "Effect.BrightnessContrast.Brightness";//CLibResource::LoadStringFromResource(L"LBLtoneBrightnessLevel",1);//L"Tone.Brightness.Level";
	colorBoostRed = "Effect.ColorBoost.Red";//CLibResource::LoadStringFromResource(L"LBLcolorBoostRed",1);//L"Color Boost.Red";
	colorBoostGreen = "Effect.ColorBoost.Green";//CLibResource::LoadStringFromResource(L"LBLcolorBoostGreen",1);//L"Color Boost.Green";
	colorBoostBlue = "Effect.ColorBoost.Blue";//CLibResource::LoadStringFromResource(L"LBLcolorBoostBlue",1);//L"Color Boost.Blue";

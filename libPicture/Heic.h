...
namespace Regards
{
	namespace Picture
	{
		...
		public:
			...
			static cv::Mat GetPicture(const string& filename, bool& isMasterSequence, int& delay,
			...
			static void SavePicture(const string& filenameOut, cv::Mat& source, uint8_t*& data_exif, unsigned int& size,

========================================================================
    BIBLIOTHÈQUE STATIQUE : Vue d'ensemble du projet libMediaInfo
========================================================================

AppWizard a créé ce projet de bibliothèque libMediaInfo à votre intention.

Aucun fichier source n'a été créé dans le cadre de votre projet.


libMediaInfo.vcxproj

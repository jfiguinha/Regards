...
ProjectPath            :=C:/Regards/libMediaInfo
...
$(OutputFile): $(Objects)
	...
	@echo rebuilt > "C:\Regards/.build-release/libMediaInfo"
...
$(IntermediateDirectory)/MediaInfo.cpp$(ObjectSuffix): MediaInfo.cpp $(IntermediateDirectory)/MediaInfo.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Regards/libMediaInfo/MediaInfo.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/MediaInfo.cpp$(ObjectSuffix) $(IncludePath)

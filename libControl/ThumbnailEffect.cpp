...
void CThumbnailEffect::ResizeThumbnail()
{
	int x = 0;
	int y = 0;
...
void CThumbnailEffect::ResizeThumbnailWithVScroll()
{
	int x = 0;
	int y = 0;
...
void CThumbnailEffect::RenderIconeWithVScroll(wxDC* deviceContext)
{
	for (auto i = 0; i < listSeparator.size(); i++)
	{
...
void CThumbnailEffect::UpdateScrollWithVScroll()
{

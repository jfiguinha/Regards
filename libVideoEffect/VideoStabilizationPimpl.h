...
class CVideoStabilizationPimpl_
{
public:
	...
	void fixBorder(Matrix& frame_stabilized)
	{
	...
	void AnalyseFrame(const Matrix& curr)
	{
		if (first)
		{
			first = false;
	...
	Matrix CorrectedFrame(Matrix& frame)
	{
		Mat T(2, 3, CV_64F);
		Matrix frame_stabilized;

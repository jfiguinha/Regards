========================================================================
    BIBLIOTHÈQUE STATIQUE : Vue d'ensemble du projet libVideoInterface
========================================================================

AppWizard a créé ce projet de bibliothèque libVideoInterface à votre intention.

Aucun fichier source n'a été créé dans le cadre de votre projet.


libVideoInterface.vcxproj
...
libVideoInterface.vcxproj.filters

...
ProjectPath            :=C:/developpement/git/Regards/libVideoFFMpeg
...
Preprocessors          :=$(PreprocessorSwitch)FFMPEG $(PreprocessorSwitch)SDL2 $(PreprocessorSwitch)YUV $(PreprocessorSwitch)OPENCL $(PreprocessorSwitch)OPENGL 
ObjectSwitch           :=-o 
ArchiveOutputSwitch    := 
...
CXXFLAGS := $(shell ../libextern/wxWidgets-master/wx-config --cppflags) -Wall -pthread  -fopenmp -std=gnu++11 -Wall -fpermissive -ggdb -O0 $(Preprocessors)
...
$(OutputFile): $(Objects)
	...
	@echo rebuilt > "C:\developpement\git\Regards/.build-debug/libVideoFFMpeg"
...
$(IntermediateDirectory)/ShowVideo.cpp$(ObjectSuffix): ShowVideo.cpp $(IntermediateDirectory)/ShowVideo.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/developpement/git/Regards/libVideoFFMpeg/ShowVideo.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ShowVideo.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ffplaycore.cpp$(ObjectSuffix): ffplaycore.cpp $(IntermediateDirectory)/ffplaycore.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/developpement/git/Regards/libVideoFFMpeg/ffplaycore.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ffplaycore.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/VideoControl_soft.cpp$(ObjectSuffix): VideoControl_soft.cpp $(IntermediateDirectory)/VideoControl_soft.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/developpement/git/Regards/libVideoFFMpeg/VideoControl_soft.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/VideoControl_soft.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ffmpegToBitmap.cpp$(ObjectSuffix): ffmpegToBitmap.cpp $(IntermediateDirectory)/ffmpegToBitmap.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/developpement/git/Regards/libVideoFFMpeg/ffmpegToBitmap.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ffmpegToBitmap.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/VideoControlInterface.cpp$(ObjectSuffix): VideoControlInterface.cpp $(IntermediateDirectory)/VideoControlInterface.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/developpement/git/Regards/libVideoFFMpeg/VideoControlInterface.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/VideoControlInterface.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/RenderBitmapInterfaceOpenGL.cpp$(ObjectSuffix): RenderBitmapInterfaceOpenGL.cpp $(IntermediateDirectory)/RenderBitmapInterfaceOpenGL.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/developpement/git/Regards/libVideoFFMpeg/RenderBitmapInterfaceOpenGL.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/RenderBitmapInterfaceOpenGL.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/SliderVideo.cpp$(ObjectSuffix): SliderVideo.cpp $(IntermediateDirectory)/SliderVideo.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/developpement/git/Regards/libVideoFFMpeg/SliderVideo.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/SliderVideo.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/VideoControl.cpp$(ObjectSuffix): VideoControl.cpp $(IntermediateDirectory)/VideoControl.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/developpement/git/Regards/libVideoFFMpeg/VideoControl.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/VideoControl.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ffmpeg_dxva2.cpp$(ObjectSuffix): ffmpeg_dxva2.cpp $(IntermediateDirectory)/ffmpeg_dxva2.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/developpement/git/Regards/libVideoFFMpeg/ffmpeg_dxva2.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ffmpeg_dxva2.cpp$(ObjectSuffix) $(IncludePath)

...
Preprocessors          :=$(PreprocessorSwitch)NDEBUG $(PreprocessorSwitch)__WXGTK__ $(PreprocessorSwitch)SDL2 $(PreprocessorSwitch)GLEW_MX 
ObjectSwitch           :=-o 
ArchiveOutputSwitch    := 
...
$(OutputFile): $(Objects)
	...
	@echo rebuilt > "/home/figuinha/dev/Regards/.build-release/libVideoFFMpeg"

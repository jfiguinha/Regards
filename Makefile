...
All:
	...
	@echo "----------Building project:[ libRegardsBpg_unix - Release ]----------"
	...
	@echo "----------Building project:[ FaceRecognition_unix - Release ]----------"
	@cd "FaceRecognition_unix" && "$(MAKE)" -f  "FaceRecognition_unix.mk"
	@echo "----------Building project:[ RegardsViewer_linux - Release ]----------"
	@cd "RegardsViewer_linux" && "$(MAKE)" -f  "RegardsViewer_linux.mk" ../include/Release/header.h.gch && "$(MAKE)" -f  "RegardsViewer_linux.mk" && "$(MAKE)" -f  "RegardsViewer_linux.mk" PostBuild
clean:
	...
	@echo "----------Cleaning project:[ libRegardsBpg_unix - Release ]----------"
	...
	@echo "----------Cleaning project:[ FaceRecognition_unix - Release ]----------"
	@cd "FaceRecognition_unix" && "$(MAKE)" -f  "FaceRecognition_unix.mk"  clean
	@echo "----------Cleaning project:[ RegardsViewer_linux - Release ]----------"

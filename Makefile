...
All:
	...
	@echo "----------Building project:[ FaceRecognition - Debug ]----------"
	@cd "FaceRecognition" && "$(MAKE)" -f  "FaceRecognition.mk"
	@echo "----------Building project:[ FaceRecognition_unix - Debug ]----------"
	@cd "FaceRecognition_unix" && "$(MAKE)" -f  "FaceRecognition_unix.mk"
	@echo "----------Building project:[ libRegardsBpg_unix - Debug ]----------"
	@cd "Otherlib/libbpg/libRegardsBpg_unix" && "$(MAKE)" -f  "libRegardsBpg_unix.mk"
	@echo "----------Building project:[ RegardsViewer_linux - Debug ]----------"
	@cd "RegardsViewer_linux" && "$(MAKE)" -f  "RegardsViewer_linux.mk" ../include/Debug/header.h.gch && "$(MAKE)" -f  "RegardsViewer_linux.mk" && "$(MAKE)" -f  "RegardsViewer_linux.mk" PostBuild
clean:
	...
	@echo "----------Cleaning project:[ FaceRecognition - Debug ]----------"
	@cd "FaceRecognition" && "$(MAKE)" -f  "FaceRecognition.mk"  clean
	@echo "----------Cleaning project:[ FaceRecognition_unix - Debug ]----------"
	@cd "FaceRecognition_unix" && "$(MAKE)" -f  "FaceRecognition_unix.mk"  clean
	@echo "----------Cleaning project:[ libRegardsBpg_unix - Debug ]----------"
	@cd "Otherlib/libbpg/libRegardsBpg_unix" && "$(MAKE)" -f  "libRegardsBpg_unix.mk"  clean
	@echo "----------Cleaning project:[ RegardsViewer_linux - Debug ]----------"
	@cd "RegardsViewer_linux" && "$(MAKE)" -f  "RegardsViewer_linux.mk" clean

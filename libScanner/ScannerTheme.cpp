...
void CScannerTheme::InitThumbnailFaceThemeToolbar()
{
...
void CScannerTheme::InitThumbnailToolbar()
{
...
void CScannerTheme::GetThumbnailFaceToolbarTheme(CThemeToolbar &theme)
{
	theme = themeThumbnailFaceToolbar;
}

void CScannerTheme::GetThumbnailToolbarTheme(CThemeToolbar &theme)
{
	theme = themeThumbnailToolbar;
}

void CScannerTheme::GetThumbnailToolbarZoomTheme(CThemeToolBarZoom &theme)
{
...
void CScannerTheme::InitThumbnailToolbarZoomTheme()
{
...
void CScannerTheme::InitFolderTheme()
{
...
void CScannerTheme::GetBitmapInfosTheme(CThemeBitmapInfos * theme)
{
...
void CScannerTheme::InitBitmapInfos()
{
...
void CScannerTheme::GetMainToolbarTheme(CThemeToolbar * theme)
{
	*theme = themeMainToolbar;
}

void CScannerTheme::GetInfosToolbarTheme(CThemeToolbar * theme)
{
	*theme = themeInfosToolbar;
}

void CScannerTheme::GetFiltreToolbarTheme(CThemeToolbar * theme)
{
	*theme = themeFiltreToolbar;
}

void CScannerTheme::GetPreviewToolbarTheme(CThemeToolbar * theme)
{
...
void CScannerTheme::InitFiltreToolbar()
{
...
void CScannerTheme::InitViewerToolbar()
{
...
void CScannerTheme::InitInfosToolbar()
{
...
void CScannerTheme::InitPreviewToolbar()
{

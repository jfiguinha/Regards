========================================================================
    BIBLIOTHÈQUE STATIQUE : Vue d'ensemble du projet libRenderBitmap
========================================================================

AppWizard a créé ce projet de bibliothèque libRenderBitmap à votre intention.

Aucun fichier source n'a été créé dans le cadre de votre projet.


libRenderBitmap.vcxproj
...
libRenderBitmap.vcxproj.filters

...
namespace RawSpeed
{
	...
	protected:
		...
		int getLong(const uchar8* ptr)
		{
			if (host == big)
				return *(int*)ptr;
			return static_cast<int>(ptr[0]) << 24 | static_cast<int>(ptr[1]) << 16 | static_cast<int>(ptr[2]) << 8 |
		...
		ushort16 getUshort(const uchar8* ptr)
		{
			if (host == big)
				return *(ushort16*)ptr;
			return static_cast<ushort16>(ptr[0]) << 8 | static_cast<ushort16>(ptr[1]);
		}
	};
	...
	private:
		...
		int getULong(const uchar8* ptr)
		{
			...
			return static_cast<unsigned int>(ptr[0]) << 24 | static_cast<unsigned int>(ptr[1]) << 16 | static_cast<
				unsigned int>(ptr[2]) << 8 | static_cast<unsigned int>(ptr[3]);
		}
	};
	...
	public:
		...
		~OpcodeFixBadPixelsConstant(void) override
		{
		};
		RawImage& createOutput(RawImage& in) override;
		void apply(RawImage& in, RawImage& out, int startY, int endY) override;
	...
	public:
		...
		~OpcodeFixBadPixelsList(void) override
		{
		};
		void apply(RawImage& in, RawImage& out, int startY, int endY) override;
	...
	public:
		...
		~OpcodeTrimBounds(void) override
		{
		};
		void apply(RawImage& in, RawImage& out, int startY, int endY) override;
	...
	public:
		...
		~OpcodeMapPolynomial(void) override
		{
		};
		RawImage& createOutput(RawImage& in) override;
		void apply(RawImage& in, RawImage& out, int startY, int endY) override;
	...
	public:
		...
		~OpcodeDeltaPerRow(void) override
		{
		};
		RawImage& createOutput(RawImage& in) override;
		void apply(RawImage& in, RawImage& out, int startY, int endY) override;
	...
	public:
		...
		~OpcodeDeltaPerCol(void) override;
		RawImage& createOutput(RawImage& in) override;
		void apply(RawImage& in, RawImage& out, int startY, int endY) override;
	...
	public:
		...
		~OpcodeScalePerRow(void) override
		{
		};
		RawImage& createOutput(RawImage& in) override;
		void apply(RawImage& in, RawImage& out, int startY, int endY) override;
	...
	public:
		...
		~OpcodeScalePerCol(void) override;
		RawImage& createOutput(RawImage& in) override;
		void apply(RawImage& in, RawImage& out, int startY, int endY) override;

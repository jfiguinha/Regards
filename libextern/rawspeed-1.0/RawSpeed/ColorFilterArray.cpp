...
namespace RawSpeed
{
	...
	{
		cfa[0] = static_cast<CFAColor>(dcrawCode & 0x3);
		cfa[1] = static_cast<CFAColor>((dcrawCode >> 2) & 0x3);
		cfa[2] = static_cast<CFAColor>((dcrawCode >> 4) & 0x3);
		cfa[3] = static_cast<CFAColor>((dcrawCode >> 6) & 0x3);
	}

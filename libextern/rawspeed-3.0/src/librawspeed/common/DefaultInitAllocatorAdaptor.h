...
public:
  ...
  template <typename U>
  void
  construct(U* ptr) noexcept(std::is_nothrow_default_constructible_v<U>) {
...
bool operator==(const DefaultInitAllocatorAdaptor<T0, A0>& x,
                const DefaultInitAllocatorAdaptor<T1, A1>& y) noexcept {

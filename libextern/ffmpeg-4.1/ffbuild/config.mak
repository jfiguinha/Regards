...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/home/jfigu_000/ffmpeg_build --extra-cflags=-I/home/jfigu_000/ffmpeg_build/include --extra-ldflags=-L/home/jfigu_000/ffmpeg_build/lib --bindir=/usr/bin --enable-gpl --enable-nonfree --enable-libaom
prefix=/home/jfigu_000/ffmpeg_build
...
CFLAGS=  -I/home/jfigu_000/ffmpeg_build/include -std=c11 -fomit-frame-pointer -IC:/msys64/mingw64/include -IC:/msys64/home/jfigu_000/ffmpeg_build/include -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -I/home/jfigu_000/ffmpeg_build/include -g
...
DEPWINDRES=gcc
DOXYGEN=doxygen
LDFLAGS= -L/home/jfigu_000/ffmpeg_build/lib  -Wl,--nxcompat,--dynamicbase -Wl,--high-entropy-va -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
...
EXTRALIBS-avcodec=-liconv -lm -llzma -LC:/msys64/mingw64/lib -lz -LC:/msys64/home/jfigu_000/ffmpeg_build/lib -laom -lole32 -luser32

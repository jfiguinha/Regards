...
wx_top_builddir="/Users/jacques/developpement/git/Regards/libextern/wxWidgets-master"
top_srcdir="../.."
flags="-D_FILE_OFFSET_BITS=64 -DwxDEBUG_LEVEL=0 -I${wx_top_builddir}/lib/wx/include/osx_cocoa-unicode-static-3.1 -I${top_srcdir}/include -O2 -fno-common "

========================================================================
    BIBLIOTHÈQUE STATIQUE : Vue d'ensemble du projet libWindowMain
========================================================================

AppWizard a créé ce projet de bibliothèque libWindowMain à votre intention.

Aucun fichier source n'a été créé dans le cadre de votre projet.


libWindowMain.vcxproj

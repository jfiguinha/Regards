...
LinkOptions            :=  -s
IncludePath            := $(IncludeSwitch)/usr/include/OpenEXR $(IncludeSwitch)/usr/include/pango-1.0 $(IncludeSwitch)/usr/include/glib-2.0 $(IncludeSwitch)/usr/lib/x86_64-linux-gnu/glib-2.0/include $(IncludeSwitch)/usr/include/cairo $(IncludeSwitch)/usr/include/SDL2 $(IncludeSwitch)/usr/include/libxml2 $(IncludeSwitch)/opt/AMDAPPSDK-3.0/include  $(IncludeSwitch). $(IncludeSwitch)../libSqlite $(IncludeSwitch)../libUtility $(IncludeSwitch)../libResource 
...
Objects0=$(IntermediateDirectory)/SqlExecuteRequest.cpp$(ObjectSuffix) $(IntermediateDirectory)/SqlLib.cpp$(ObjectSuffix) $(IntermediateDirectory)/SqlResult.cpp$(ObjectSuffix) $(IntermediateDirectory)/SqlEngine.cpp$(ObjectSuffix) 
...
$(OutputFile): $(Objects)
	...
	@echo rebuilt > "/home/figuinha/developpement/Regards/.build-release/libSqlEngine"

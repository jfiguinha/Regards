...
class CBoxFilter : public CPass2Scale
{
public:

	CBoxFilter(double dWidth = double(0.5)) : CPass2Scale(dWidth) {}
	virtual ~CBoxFilter() {}
...
class CBilinearFilter : public CPass2Scale
{
public:

	CBilinearFilter(double dWidth = double(1.0)) : CPass2Scale(dWidth) {}
...
class CGaussianFilter : public CPass2Scale
{
public:

	CGaussianFilter(double dWidth = double(1.25)) : CPass2Scale(dWidth) {}
...
class CHammingFilter : public CPass2Scale
{
public:

	CHammingFilter(double dWidth = double(1.0)) : CPass2Scale(dWidth) {}
...
class CCubicFilter : public CPass2Scale
{
public:

	CCubicFilter(double dWidth = double(2.0)) : CPass2Scale(dWidth) {}
...
class CBlackmanFilter : public CPass2Scale
{
public:

	CBlackmanFilter(double dWidth = double(1.0)) : CPass2Scale(dWidth) {}
...
class CQuadraticFilter : public CPass2Scale
{
public:

	CQuadraticFilter(double dWidth = double(1.5)) : CPass2Scale(dWidth) {}
...
class CMitchellFilter : public CPass2Scale
{
public:

	CMitchellFilter(double dWidth = double(2.0)) : CPass2Scale(dWidth) {}
...
class CTriangleFilter : public CPass2Scale
{
public:

	CTriangleFilter(double dWidth = double(1.0)) : CPass2Scale(dWidth) {}
...
class CSincFilter : public CPass2Scale
{
public:

	CSincFilter(double dWidth = double(1.5)) : CPass2Scale(dWidth) {}
	virtual ~CSincFilter() {}
...
class CBesselFilter : public CPass2Scale
{
public:

	CBesselFilter(double dWidth = double(1.5)) : CPass2Scale(dWidth) {}
...
class CBlackmanBesselFilter : public CPass2Scale
{
public:

	CBlackmanBesselFilter(double dWidth = double(3.2383)) : CPass2Scale(dWidth) {}
...
class CLanczosFilter : public CPass2Scale
{
public:

	CLanczosFilter(double dWidth = double(3.0)) : CPass2Scale(dWidth) {}
...
class CBlackmanSincFilter : public CPass2Scale
{
public:

	CBlackmanSincFilter(double dWidth = double(4.0)) : CPass2Scale(dWidth) {}
...
class CCatromFilter : public CPass2Scale
{
public:

	CCatromFilter(double dWidth = double(2.0)) : CPass2Scale(dWidth) {}
...
class CHanningFilter : public CPass2Scale
{
public:

	CHanningFilter(double dWidth = double(1.0)) : CPass2Scale(dWidth) {}
...
class CHermiteFilter : public CPass2Scale
{
public:

	CHermiteFilter(double dWidth = double(1.5)) : CPass2Scale(dWidth) {}

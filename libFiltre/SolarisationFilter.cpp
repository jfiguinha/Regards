...
void CSolarisationFilter::Filter(CEffectParameter* effectParameter, cv::Mat& source, const wxString& filename,
                                 IFiltreEffectInterface* filtreInterface)
{
	auto solarisationEffectParameter = static_cast<CSolarisationEffectParameter*>(effectParameter);
	...
	filtreInterface->AddTreeInfos(libelleEffectThreshold,
	                              new CTreeElementValueInt(solarisationEffectParameter->threshold), &elementColor);
}

void CSolarisationFilter::FilterChangeParam(CEffectParameter* effectParameter, CTreeElementValue* valueData,
                                            const wxString& key)
{
	auto solarisationEffectParameter = static_cast<CSolarisationEffectParameter*>(effectParameter);
...
void CSolarisationFilter::RenderEffect(CFiltreEffet* filtreEffet, CEffectParameter* effectParameter,
                                       const bool& preview)
{
...
{
	auto solarisation = new CSolarisationEffectParameter();
...
void CSolarisationFilter::ApplyPreviewEffectSource(CEffectParameter* effectParameter, IBitmapDisplay* bitmapViewer,
...
void CSolarisationFilter::ApplyPreviewEffect(CEffectParameter* effectParameter, IBitmapDisplay* bitmapViewer,
